...
public class SceneLoader {
    ...
    private void caricaSceneDefault() {
        ...
        sceneManager.aggiungiSceneDefault("Stanza degli ospiti", "Letti vuoti, lenzuola scomposte. Chi è passato di qui? \nUna stanza molto disordinata, tanto da farti inciampare su qualcosa. Guardando meglio, noti che è sotto il materasso capovolto c'è una CHIAVE nuova di zecca ... con una scritta che dice 'Top Secret', forse apre la stanza segreta che Wilbur mi ha detto di cercare.");
    ...
    private void caricaSceneEvento() {
        ...
        sceneManager.aggiungiSceneEvento("chiave_segreta", "Una chiave misteriosa. Potrebbe aprire qualcosa di importante... magari la stanza segreta? Esplora le altre stanze");
