...
public class  Mappa {
    ...
    private void inizializza(List<Scena> scene) {
        ...
        stanze[2][3] = new Stanza("Stanza Segreta", false, true, false, false,false,false,true,false, scene.get(13), null, null);
        ...
        stanze[0][9] = new Stanza("Stanza degli ospiti", true, false, false, false, false, false, false, true, scene.get(20), "chiave_segreta", List.of("chiave segreta"));
