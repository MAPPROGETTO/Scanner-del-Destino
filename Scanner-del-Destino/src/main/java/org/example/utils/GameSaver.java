...
/**
 * Classe per salvare e caricare lo stato del gioco.
 * Lo stato viene serializzato in file nella cartella "salvataggi".
 * Sono disponibili 3 slot di salvataggio.
 * Se tutti gli slot sono pieni, viene chiesto se sovrascrivere lo slot 1.
 */
public class GameSaver implements Serializable{
     ...
     * @param stato lo stato di gioco da salvare
     * @param slotForzato se >0, forza il salvataggio in quello slot
     */
     ...
     * @param slot lo slot da cui caricare (1-3)
     * @return lo stato di gioco caricato o null in caso di errore
     */
     ...
     * @param slot lo slot da controllare (1-3)
     * @return true se esiste un salvataggio valido
     */
