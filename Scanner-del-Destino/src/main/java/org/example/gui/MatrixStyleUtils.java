...
public class MatrixStyleUtils{
    ...
    /**
     * Crea un pannello superiore con bordo Matrix
     * @param mappaButton
     * @param inventarioButton
     * @return
     */
    ...
    /**
     * Crea un pannello inventario con bordo Matrix
     *
     * @param inventario
     * @param inventarioVisibile
     * @return
     */
    ...
    public static class MatrixChar {
        ...
        /**
         * Aggiorna la posizione e il carattere
         */
        public void update() {
            y += speed;
        ...
        /**
         * Genera un carattere casuale dalla stringa MATRIX_CHARS
         * @return
         */
