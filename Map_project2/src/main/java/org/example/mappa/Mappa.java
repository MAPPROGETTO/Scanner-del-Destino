...
public class  Mappa {
    ...
    private void inizializza(List<Scena> scene) {
        ...
        stanze[5][10] = new Stanza("Bagno", false, false, true, false, false,false,false,true, scene.get(10), "chiave_matrimoniale", List.of("chiave", "chiave matrimoniale"));
        stanze[2][3] = new Stanza("Stanza Segreta", false, true, false, false,false,true,false,false, scene.get(13), null, null);
        stanze[5][2] = new Stanza("Scale", true, false, false, true,true,false,true,false, scene.get(12), null, null);

        // Secondo piano
        stanze[3][9] = new Stanza("Stanza Matrimoniale", true, true, true, false, false, false, false, true, scene.get(16), "motore", null);
        ...
        stanze[0][9] = new Stanza("Stanza degli ospiti", true, false, false, false, false, false, false, true, scene.get(20), "chiave_segreta", List.of("chiave", "chiave segreta"));
