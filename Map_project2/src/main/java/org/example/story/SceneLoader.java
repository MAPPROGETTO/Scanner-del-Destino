...
public class SceneLoader {
    ...
    private void caricaSceneDefault() {
        ...
        sceneManager.aggiungiSceneDefault("Stanza degli ospiti", "Letti vuoti, lenzuola scomposte. Chi è passato di qui? \nUna stanza molto disordinata, tanto da farti inciampare su qualcosa. Guardando meglio, noti che è sotto il materasso capovolto c'è una chiave ... semnbra nuova di zecca, con una scritta che dice 'Top Secret', forse apre la stanza segreta che Wilbur mi ha detto di cercare.");
    ...
    private void caricaSceneEvento() {
        sceneManager.aggiungiSceneEvento("chiave", "Hai raccolto una chiave arrugginita. Potrebbe aprire la porta della camera matrimoniale.");
        ...
        sceneManager.aggiungiSceneEvento("batteria", "Hai trovato un altro pezzo! Lo Scanner è quasi pronto per essere riattivato. Nel frattempo Lewis conserva la foto...");
