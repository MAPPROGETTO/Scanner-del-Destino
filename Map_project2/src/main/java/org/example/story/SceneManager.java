...
public class SceneManager {
    ...
    public void aggiungiSceneUsoOggetto(String stanza, String oggetto, Scena scena) {
        sceneUsoOggetti.put(stanza + ":" + oggetto, scena);
    }
    ...
    public Optional<Scena> getEventoPericolosoPerStanza(String stanza) {
        if (stanza.equalsIgnoreCase("balcone")) {
            return getSceneEvento("evento_pericoloso_balcone");
        }
        // Puoi aggiungere altri casi per altre stanze pericolose
