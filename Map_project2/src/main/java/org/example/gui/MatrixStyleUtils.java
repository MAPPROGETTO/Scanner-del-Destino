...
public class MatrixStyleUtils {
    ...
    public static JButton createStyledButton(String text, ImageIcon icon) {
        ...
        button.setFont(MONOSPACE_FONT);
        button.setBackground(BUTTON_BACKGROUND);
        button.setForeground(Color.WHITE);
        button.setFocusPainted(false);
        button.setBorder(createMatrixBorder());

        addHoverEffect(button, MATRIX_GREEN_DARK, BUTTON_BACKGROUND);

        return button;
    }

    /**
     * Crea un pulsante con stile Matrix personalizzato
     */
    ...
    public static JTextArea createStyledTextArea() {
        ...
        areaTesto.setBackground(DARK_BACKGROUND);
        areaTesto.setForeground(TEXT_COLOR);
        areaTesto.setFont(MONOSPACE_FONT);
