    ...
    public String interpretaComandoDaGUI(String comando) {
        ...
        switch (verbo) {
            case "prendi":
                ...
                // Rimuovi l'oggetto dalla stanza (se previsto)
            ...
            case "sali":
                if (isScala(oggetto)) {
                    if (stanza != null && stanza.getNome().equalsIgnoreCase("scale") || stanza.getNome().equalsIgnoreCase("scala") || stanza.getNome().contains("le scale")) {
