...
public class MappaPanel extends JPanel implements Serializable {
    ...
    private transient static final Color WALL_COLOR = MatrixStyleUtils.MATRIX_GREEN;
    private transient static final Color DOOR_COLOR = MatrixStyleUtils.MATRIX_GREEN_TRANSPARENT;
    private transient static final Color STAIRS_COLOR = MatrixStyleUtils.MATRIX_GREEN_LIGHT;
    private transient static final Color PLAYER_COLOR = MatrixStyleUtils.MATRIX_GREEN;
    private transient static final Color VISITED_COLOR = MatrixStyleUtils.MATRIX_GREEN_DARK;
    private static final Color SECRET_ROOM_COLOR = new Color(0, 150, 40, 80);
    private transient static final Color ITEM_COLOR = MatrixStyleUtils.MATRIX_GREEN;
